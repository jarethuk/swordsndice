...
export const Button = ({ content, variant, onPress, loading, disabled }: Props) => {
  return (
    <Pressable
      className={clsx('w-full overflow-hidden rounded-2xl', {
        ...
        'bg-secondaryShadow-light dark:bg-secondaryShadow-dark': variant === 'secondary',
        'border-border-light dark:border-border-dark border-2': variant === 'outline',
      ...
      <View
        className={clsx(
          ...
          {
            'bg-primary-light dark:bg-primary-dark': !variant || variant === 'primary',
            'bg-secondary-light dark:bg-secondary-dark': variant === 'secondary',
