    ...
    <View className={'mt-6 mb-3 flex w-full flex-col items-center gap-4'}>
      <View className={'flex flex-row gap-4'}>
        <Pressable
          onPress={() => router.back()}
          className={
            'bg-panel-light dark:bg-panel-dark flex h-12 w-12 items-center justify-center overflow-hidden rounded-full'
          }>
          <FontAwesomeIcon icon={faChevronLeft} size={16} color={colours.text} />
        </Pressable>
        ...
        {onEdit ? (
          <Pressable
            ...
            <FontAwesomeIcon icon={faEdit} size={16} color={colours.text} />
          </Pressable>
        ) : (
