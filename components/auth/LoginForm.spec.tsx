...
describe('LoginForm', () => {
  ...
  it('logs in user when code is entered', async () => {
    ...
    mockMutateAsync.mockResolvedValueOnce(undefined).mockResolvedValueOnce(mockUser);
  ...
  it('shows loading screen while logging in', async () => {
    ...
    mockMutateAsync.mockResolvedValueOnce(undefined).mockReturnValueOnce(promise as any);
  ...
  it('displays API error message when login fails', async () => {
    ...
    mockMutateAsync.mockResolvedValueOnce(undefined).mockRejectedValueOnce(new Error(errorMessage));
