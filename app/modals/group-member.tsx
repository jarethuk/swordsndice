...
export default function GroupMemberDialog() {
  ...
  const { mutateAsync: apiRemoveMember } = useAPIRemoveMemberFromGroup(groupId as string);
  const { mutateAsync: apiUpdateMember } = useAPIUpdateGroupMember(groupId as string);
